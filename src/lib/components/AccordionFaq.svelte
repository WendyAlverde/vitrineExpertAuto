            ...
            content: [
                {
                    ...
                    items: [
                        ...
                        "En cas de refus : Si l’expert et votre assureur maintiennent leur position, vous devrez faire appel à un <strong>Expert en Automobiles</strong> indépendant. Cet expert pourra procéder à une évaluation contradictoire avec l’expert initial pour déterminer la juste valeur de votre <strong>véhicule</strong>.",
                ...
                'Nota important :',
                'Si vous contestez la VRADE après avoir signé les papiers de cession du <strong>véhicule</strong>, il est possible que l’accès au <strong>véhicule</strong> soit impossible. Cela limiterait alors la capacité d’évaluer précisément son état et pourrait affaiblir votre position dans le débat concernant sa valeur.',
            ]
        },
        {
